...
namespace DoctorAp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            _logger = logger;
            _connectionString = "Server=tcp:digigroup30.database.windows.net,1433;Initial Catalog=73;Persist Security Info=False;User ID=sqladmin;Password=Blackbird127;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
        }
